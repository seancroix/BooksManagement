    ...
    ?>
           <div class="container">
            ...
            <div class="leftinnerdiv">
                <Button class="bluebtn" >WELCOME!</Button>
                <Button class="bluebtn" onclick="openpart('myaccount')"> My Account</Button>
                <Button class="bluebtn" onclick="openpart('requestbook')"> Request Book</Button>
                <Button class="bluebtn" onclick="openpart('issuereport')"> Book Report</Button>
            ...
            <Button class="bluebtn" >My Account</Button>
            ...
            <Button class="bluebtn" >ISSUE RECORD</Button>
            ...
            <Button class="bluebtn" >Return Book</Button>
            ...
            <Button class="bluebtn" >Request Book</Button>
