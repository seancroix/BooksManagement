...
function addbook($bookpic,$bookname,$bookdetail,$bookauthor,$bookpublish,$branch,$bookprice,$bookquantity){
    ...
    $q="INSERT INTO book (bookpic, bookname, bookdetail, bookauthor, bookpublish, branch, bookprice, bookquantity, bookrent) 
...
function requestbook($userid,$bookid){
    ...
    if($this->connection->exec($q)) {
        ...
        header("Location:otheruser_dashboard.php?msg=Connection failed!");
    }
